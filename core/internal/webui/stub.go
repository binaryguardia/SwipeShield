...
func serve(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Fprint(w, `<!doctype html><html><head><meta charset="utf-8"><title>SwipeShield</title></head>
...
<h1 style="font-size:1.4rem">SwipeShield dashboard not bundled</h1>
...
cd core && go build -tags webui -o swipeshield ./cmd/swipeshield</pre>
</main></body></html>`)
}
